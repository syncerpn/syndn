...
void init_connected_layer(layer l, initializer init) {
    init.auto_sigma = sqrt(1./l.inputs);
    initialize_array(l.weights, l.outputs*l.inputs, init);
    ...
    switch (a.optim) {
        ...
        default:
            ...
            if(l.batch_normalize){
                ...
                scal_gpu(l.outputs, a.momentum, l.scale_updates_gpu, 1);
            }
            ...
            scal_gpu(l.inputs*l.outputs, a.momentum, l.weight_updates_gpu, 1);
            break;
    }
}
...
void backward_connected_layer_gpu(layer l, network net)
{
    ...
    //nghiant_20190321: add impact factor
    // if(c) gemm_gpu(0,0,m,n,k,1,a,k,b,n,1,c,n);
    if(c) gemm_gpu(0,0,m,n,k,l.impact,a,k,b,n,1,c,n);
}