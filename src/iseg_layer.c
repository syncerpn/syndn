...
void forward_iseg_layer_gpu(const layer l, network net)
{
    ...
    int b;
    for (b = 0; b < l.batch; ++b){
        activate_array_gpu(l.output_gpu + b*l.outputs, l.classes*l.w*l.h, (activation_scheme){LOGISTIC});
        //if(l.extra) activate_array_gpu(l.output_gpu + b*l.outputs + l.classes*l.w*l.h, l.extra*l.w*l.h, (activation_scheme){LOGISTIC});
    }
...
void backward_iseg_layer_gpu(const layer l, network net)
{
    int b;
    for (b = 0; b < l.batch; ++b){
        //if(l.extra) gradient_array_gpu(l.output_gpu + b*l.outputs + l.classes*l.w*l.h, l.extra*l.w*l.h, (activation_scheme){LOGISTIC}, l.delta_gpu + b*l.outputs + l.classes*l.w*l.h);
    }
