...
void train_isegmenter(char *datacfg, char *cfgfile, char *weightfile, char* modules, int *gpus, int ngpus, int clear, int display)
{
    int i;
...
void predict_isegmenter(char *datafile, char *cfg, char *weights, char* modules, char *filename)
{
...
void demo_isegmenter(char *datacfg, char *cfg, char *weights, char* modules, int cam_index, const char *filename)
{
...
void run_isegmenter(int argc, char **argv)
{
    ...
    if(0==strcmp(argv[2], "test")) predict_isegmenter(data, cfg, weights, modules, filename);
    else if(0==strcmp(argv[2], "train")) train_isegmenter(data, cfg, weights, modules, gpus, ngpus, clear, display);
    else if(0==strcmp(argv[2], "demo")) demo_isegmenter(data, cfg, weights, modules, cam_index, filename);
}
