...
void train_segmenter(char *datacfg, char *cfgfile, char *weightfile, char* modules, int *gpus, int ngpus, int clear, int display)
{
    int i;
...
void predict_segmenter(char *datafile, char *cfg, char *weights, char* modules, char *filename)
{
...
void demo_segmenter(char *datacfg, char *cfg, char *weights, char* modules, int cam_index, const char *filename)
{
...
void run_segmenter(int argc, char **argv)
{
    ...
    if(0==strcmp(argv[2], "test")) predict_segmenter(data, cfg, weights, modules, filename);
    else if(0==strcmp(argv[2], "train")) train_segmenter(data, cfg, weights, modules, gpus, ngpus, clear, display);
    else if(0==strcmp(argv[2], "demo")) demo_segmenter(data, cfg, weights, modules, cam_index, filename);
}
